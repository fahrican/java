...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        while (testCases > 0) {
            ...
            try {
                checkForCustomAnnotation(role, spend);
            } catch (Exception e) {
                e.printStackTrace();
            }
            testCases--;
    ...
    private static void checkForCustomAnnotation(String role, int spend) throws IllegalAccessException, InvocationTargetException, InstantiationException {
