package bwi.prog1B.WS1617.wi16b027_Can.Experiments;
...
public class LendItemFunctions {
	...
	public static int compareByLendDate(LendItem it1, LendItem it2){
		...
		boolean itEqual = it1.lendDate.year == it2.lendDate.year
				&& it1.lendDate.month == it2.lendDate.month
				&& it1.lendDate.day == it2.lendDate.day;
	...
	public static int compareByReturnDate(LendItem it1, LendItem it2) {
		...
		boolean itEqual = it1.returnDate.year == it2.returnDate.year && it1.returnDate.month == it2.returnDate.month
				&& it1.returnDate.day == it2.returnDate.day;
	...
	public static Date scanDate(){
		...
		} while (!(userDate.year > 1581 && userDate.month > 0 && userDate.month < 13  && userDate.day > 0 && userDate.day < 32));
